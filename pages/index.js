    ...
    return <div className="page">
        ...
        <section className="bg-gray-200">
            <div className="container mx-auto py-20">
                ...
                <div className="flex space-x-2 justify-between mt-10 xl:px-40">
                    <div>
                        <svg height="{30}" viewBox="0 0 152 44" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <section>
            ...
            <div className="container mx-auto space-y-10">
                <div className="flex items-center justify-between xl:px-24 2xl:px-48 flex-col md:flex-row px-2 lg:px-0">
                    <div className="pb-12 lg:pb-0 lg:w-4/12">
                        <div className="block mb-2"><span className="text-blue-600 text-xs font-bold ">PUBLISH</span>
                        </div>

                        <h3 className="mb-4 font-bold text-gray-800 text-4xl">Visually plan and schedule your social
                            media
                            campaigns</h3>

                        <p>Coordinate creative campaigns to drive engagement on social.</p>

                        <div className="mt-8 text-blue-600 hover:text-blue-800 font-bold">
                            <a className="mt-8 flex items-center" href="#"><span className="pr-2">Learn more</span>
                                <svg width="30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor">
                ...
                <div className="flex items-center justify-between xl:px-24 2xl:px-48 flex-col md:flex-row md:flex-row-reverse px-2 lg:px-0">
                    <div className="pb-12 lg:pb-0 lg:w-4/12">
                        <div className="block mb-2"><span className="text-red-600 text-xs font-bold ">PUBLISH</span>
                        </div>
                        ...
                        <div className="mt-8 text-red-600 hover:text-red-800 font-bold">
                            <a className="mt-8 flex items-center" href="#"><span className="pr-2">Learn more</span>
                                <svg width="30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                ...
                <div className="flex items-center justify-between xl:px-24 2xl:px-48 flex-col md:flex-row px-2 lg:px-0">
                    <div className="pb-12 lg:pb-0 lg:w-4/12">
                        <div className="block mb-2"><span className="text-green-600 text-xs font-bold ">PUBLISH</span>
                        </div>
                        ...
                        <div className="mt-8 text-green-600 hover:text-green-800 font-bold">
                            <a className="mt-8 flex items-center" href="#"><span className="pr-2">Learn more</span>
                                <svg width="30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
